...
class media_t
{
    private:
        ...
        vector<quality_t> qualities; /**< The media qualities (example: "low" and
        "medium"). */
        float rating; /**< The media rating (example: "."). */
        int year; /**< The media year (example: "2011"). */
    protected:
        string announcement; /**< The announcement to print when the media is played
        (example: "The anime is played!"). */
    public:
        /**
        * Constructs a new media.
        * Initializes its announcement to "undefined", its name to "undefined", its rating
        to "-1" and its year to "-1".
        */
        media_t();
        /**
        ...
        */
        ...
        void print() const;//pour tester à enlever plus tard
};
